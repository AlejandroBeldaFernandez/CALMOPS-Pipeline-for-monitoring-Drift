# ClinicGenerator API Reference

The `ClinicGenerator` class provides a comprehensive suite of tools for generating synthetic clinical datasets, including demographic, gene expression (RNA-Seq and Microarray), and protein expression data. It supports complex correlation structures, disease effects, and various types of data drift.
