...
class ClinicGenerator(SyntheticGenerator):
    """
    Specialized Synthetic Generator for Clinical Data.
    Inherits from SyntheticGenerator but adds domain-specific logic, such as ensuring
    feature names are clinically relevant (e.g., BloodPressure, HeartRate).
    """

    CLINICAL_FEATURE_MAP = {
        # String based (SyntheticGenerator fallback)
        "x0": "Systolic_BP",
        "x1": "Diastolic_BP",
        "x2": "Heart_Rate",
        "x3": "Body_Temp",
