...
def data_loader(
    ...
    *,
    ...
    Returns:
    -------
    (dataframe, file_name, modification_time)
      - dataframe: pandas.DataFrame (FULL dataset; no per-block slicing here)
      - file_name: str or None
      - modification_time: float or None
    Side effects:
    ...
    # logs dir consistent with the pipeline structure: pipelines/<name>/logs
